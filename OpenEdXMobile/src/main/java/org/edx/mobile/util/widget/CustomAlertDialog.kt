/*
* Copyright 2022 Orenda Pvt. Ltd (https://www.taleemabad.com/)
*
...
*/
package org.edx.mobile.util.widget

/**
 * The file CustomAlertDialog
 *
 * @author  Mirza Adil
 ...
 * @since 27 Jul 2022
 *
 * This CustomAlertDialog class is used to custom Animation Lottie files Dialog.
 */
...
class CustomAlertDialog : AlertDialog {
    ...
    data class Builder(
        ...
        fun setPositiveListener(positiveListener: ClickListener?): Builder =
        ...
        fun getPositiveListener(): ClickListener? {
